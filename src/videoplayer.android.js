...
var Video = (function (_super) {
    ...
    function Video() {
        ...
        _this.interval = null;
        _this._mInfo = new global.technology.master.exoplayer.PlayBackInformationJava();
        _this._gaudioProcessor = new global.technology.master.exoplayer.GaudioProcessJava(_this._mInfo);
        return _this;
    }
    ...
    Video.prototype._openVideo = function () {
        ...
        try {
            ...
            this.mediaPlayer = com.google.android.exoplayer2.ExoPlayerFactory.newSimpleInstance(new global.technology.master.exoplayer.ProcessorFactory(this._context, this._gaudioProcessor), trackSelector);
